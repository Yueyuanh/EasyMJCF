...
class MeshSimplify:
    ...
    def simplify_mesh(self,input_path, output_path, ratio):
        try:
    ...
    def batch_simplify(self,input_dir,output_dir, ratio):
        ...
        for root, _, files in os.walk(input_dir):
            for file in files:
                if file.lower().endswith(".stl"):
                    ...
                    success = self.simplify_mesh(in_path, out_path, ratio)
                    if success:
