...
# # 实用函数
# def create_project_structure(project_name: str, base_dir: str = "."):
#     """
#     创建标准项目文件夹结构
#     """
#     structure = {
...
#         FolderManager.create_folder(parent_path)
        
#         for child in children:
#             child_path = os.path.join(parent_path, child)
#             FolderManager.create_folder(child_path)
    
#     print(f"项目结构创建完成: {project_name}")

# # 使用示例
# if __name__ == "__main__":
#     # 示例1: 创建文件夹
#     FolderManager.create_folder("test_folder")
#     FolderManager.create_folder("nested/folder/structure")
    
#     # 示例2: 重命名文件夹
#     FolderManager.create_folder("old_name")
#     FolderManager.rename_folder("old_name", "new_name")
    
#     # 示例3: 创建带权限的文件夹
#     FolderManager.create_with_permissions("private_folder", 0o700)
    
#     # 示例4: 创建项目结构
#     create_project_structure("my_project")
    
#     # 示例5: 使用 pathlib
#     FolderManagerModern.create_folder("modern_folder")
#     FolderManagerModern.rename_folder("modern_folder", "renamed_folder")